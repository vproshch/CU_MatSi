%{
This function reads a .xyz file and converts it to a matrix of postions
...
while last
    ...
    elseif strcmp(pi,'')
        ...
        Pos(1,i)= str2double(pos{2});
        Pos(2,i)= str2double(pos{3});
        Pos(3,i)= str2double(pos{4});
        i = i + 1;
    end
end
fclose all
